...
<nav class="navbar navbar-expand-lg" style="background-color: #0060B1;">
    ...
    <div class="container-fluid" style="padding: 15%;">

        <form>
            <div class="form-group">
                <label for="exampleFormControlInput1">Endereço de email</label>
                <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="nome@exemplo.com" style="box-shadow: -7px 5px 13px 1px #00000010;">
            </div>
            <div class="form-group">
                <label for="exampleFormControlSelect1">Selecione seu Problema</label>
                <select class="form-control" id="exampleFormControlSelect1" style="box-shadow: -7px 5px 13px 1px #00000010;">
                    <option>Problemas com Produto</option>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" style="box-shadow: -7px 5px 13px 1px #00000010;"></textarea>
            </div>

            <div class="form-group">
                    <label for="exampleFormControlTextarea1"></label>
                    <input type="file" class="form-control-file" id="exampleFormControlFile1" style="margin-top: 5%">
                </div>
    
            <button type="submit" class="btn btn-primary" style="margin-top: 10px">Enviar Mensagem</button>
            ...
            <div class="row">
                <div class="col-4">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-link">
                            <a href="faleconosco.html" class="text-decoration-none" style="color:white" ;>Suporte</a>
                        </li>
                    </ul>
                </div>
                <div class="col-8">
                    <p>
                        O BOOM! é uma empresa brasileira, pelo grupo de TI do Senac Campo Grande. Desde o início, o foco da companhia é o comércio
                        digital de produtos eletrônicos.
                    </p>
                </div>
            </div>
        </div>
