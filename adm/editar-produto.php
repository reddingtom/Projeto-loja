      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        <div class="col-12 col-md-8 col-lg-6 col-xl-10">
          <div class="card shadow-2-strong" style="border-radius: 1rem; box-shadow: -7px 5px 13px 1px #00000010;">
            ...
            $idprod = $_GET["cod"];
            $sql = "select * from itens where idprod = '".$idprod."';";
            $result = mysqli_query($con, $sql);
            
            $row = mysqli_fetch_array($result);
            
            ?>
              <form action="../php/atualizarprod.php" method="post">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style="margin-top: 1%; margin-bottom: 1%; "
                      name="quantidade" value="<?php echo $row["quantidade"]; ?>">
                  </div>
                  <input type="hidden" name="cod" value="<?php echo $row["idprod"]; ?>">
                </div>
                <div class="form-group row">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Preço</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" style="margin-top: 1%; margin-bottom: 1%;"
                      name="preco" value="<?php echo $row["preco"]; ?>">
                  </div>
                </div>
                <div class="form-group row">
                ...
                <center>
                  <a href="consultarproduto.html" class="text-decoration-none row d-flex justify-content-cente">
                    <div class="d-grid gap-1 col-2 center">
  ...
  <footer class="text-light" style="background-color: #0060B1;">
    <div class="container-fluid py-3">
      <div class="row">
        ...
        <div class="col-8">
          <p>
            O BOOM! é uma empresa brasileira, pelo grupo de TI do Senac Campo Grande. Desde o início, o foco
            da companhia é o comércio digital de produtos eletrônicos.
          </p>
        </div>
      </div>
    </div>
