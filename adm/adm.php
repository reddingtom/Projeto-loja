...
<nav class="navbar navbar-expand-lg" style="background-color: #0060B1;">
  ...
  <div class="container-fluid"style="padding: 18%">
            <div class="card h-100 container-fluid" style="box-shadow: -7px 5px 13px 1px #00000010;">
                <div class="card-body">
                    <h5 class="card-title row d-flex justify-content-center">Olá Adm <?php echo $_SESSION["nome"]; ?></h5>
                    <div class="d-grid gap-3 col-3 mx-auto">
                        <a href="adicionarproduto.php" class="text-decoration-none row d-flex justify-content-cente">
                            <input type="button" value="Adicionar Produto" class="btn btn-primary">
                        </a>
                        <a href="editarproduto.php" class="text-decoration-none row d-flex justify-content-cente">
                            <input type="button" value="Editar Produto" class="btn btn-primary">
                        </a>
                        <a href="consultarproduto.php" class="text-decoration-none row d-flex justify-content-cente">
                            <input type="button" value="Consultar Produto" class="btn btn-primary">
                        </a>
                        <a href="../php/sairdasessao.php" class="text-decoration-none row d-flex justify-content-cente">
                          <input type="button" value="Sair" class="btn btn-danger" style="background-color: #FF6500;">
                      </a>
                    </div>
                </div>
            </div>
